...
import { mobilityDeltaSatisfied } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mobility_delta'
import {
...
import { movedPieceParticipatesInAttackOrDefend } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_participates_in_attack_or_defend'
import { movedPieceParticipatesAdjacent } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_participates_adjacent'
import { movedPieceParticipatesShield } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_participates_shield'
import { movedPieceObstructsInAttackOrDefend } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_obstructs_in_attack_or_defend'
import { movedPieceObstructsShield } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_obstructs_shield'
import { movedPieceShiftsOwnMobility } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_shifts_own_mobility'
import { movedPieceShiftsAlliedMobility } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_shifts_allied_mobility'
import { movedPieceShiftsEnemyKingMobility } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_shifts_enemy_king_mobility'
import { movedPieceShiftsEnemyMobility } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_shifts_enemy_mobility'
import { movedPieceCapturesRelationParticipant } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_captures_relation_participant'
import { movedPieceShiftsRegionMembership } from 'editorV2/panels/condition_preview/forward_proposition/cross_frame/mechanisms/moved_piece_shifts_region_membership'
