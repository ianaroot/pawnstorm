const swatch = (cssVar) =>
  `<span aria-hidden="true" style="display:inline-block;width:14px;height:14px;vertical-align:middle;background:var(${cssVar});border-radius:3px;margin:0 2px;"></span>`
...
const organizerIcon = `<svg aria-hidden="true" width="64" height="14" viewBox="0 0 64 14" style="vertical-align:middle;margin:0 2px;"><rect width="64" height="14" rx="2" fill="#475569"/><text x="32" y="10" text-anchor="middle" fill="#cbd5e1" font-size="7" font-family="sans-serif">ENDGAME</text></svg>`
